...
The following code can be seen in action in the [BLE Explorer sample app](https://github.com/xamarin/Monkey.Robotics/tree/master/Sample%20Apps/BLE%20Explorer).
