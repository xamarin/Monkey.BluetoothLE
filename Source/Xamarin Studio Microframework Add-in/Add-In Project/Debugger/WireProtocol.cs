...
namespace Microsoft.SPOT.Debugger.WireProtocol
{
	...
	public class Flags
	{
		public const ushort c_NonCritical = 0x0001;
		// This doesn't need an acknowledge.
		public const ushort c_Reply = 0x0002;
	...
	public class Packet
	{
		public static string MARKER_DEBUGGER_V1 = "MSdbgV1\0";
		// Used to identify the debugger at boot time.
		public static string MARKER_PACKET_V1 = "MSpktV1\0";
		// Used to identify the start of a packet.
	...
	{
		public const uint c_Monitor_Ping = 0x00000000;
		// The payload is empty, this command is used to let the other side know we are here...
		public const uint c_Monitor_Message = 0x00000001;
		// The payload is composed of the string characters, no zero at the end.
		...
		public const uint c_Monitor_ProgramExit = 0x00000009;
		// The payload is empty, this command is used to tell the PC of a program termination
		...
		public class Monitor_SignatureKeyUpdate
		{
			...
			public bool PrepareForSend(uint keyIndex, byte[] newPublicKeySig, byte[] newPublicKey, byte[] reserveData)
			{
				...
				if(newPublicKey.Length != m_newPublicKey.Length)
					return false;

				if(newPublicKeySig != null)
				{
					if(newPublicKeySig.Length != m_newPublicKeySignature.Length)
						return false;
		...
		public const uint c_Debugging_Execution_BasePtr = 0x00020000;
		// Returns the pointer for the ExecutionEngine object.
		public const uint c_Debugging_Execution_ChangeConditions = 0x00020001;
		// Sets/resets the state of the debugger.
		public const uint c_Debugging_Execution_SecurityKey = 0x00020002;
		// Sets security key.
		public const uint c_Debugging_Execution_Unlock = 0x00020003;
		// Unlocks the low-level command, for mfg. test programs.
		public const uint c_Debugging_Execution_Allocate = 0x00020004;
		// Permanently allocates some memory.
		public const uint c_Debugging_Execution_Breakpoints = 0x00020005;
		// Sets breakpoints.
		public const uint c_Debugging_Execution_BreakpointHit = 0x00020006;
		// Notification that a breakpoint was hit.
		public const uint c_Debugging_Execution_BreakpointStatus = 0x00020007;
		// Queries last breakpoint hit.
		public const uint c_Debugging_Execution_QueryCLRCapabilities = 0x00020008;
		// Queries capabilities of the CLR.
		public const uint c_Debugging_Execution_SetCurrentAppDomain = 0x00020009;
		// Sets current AppDomain for subsequent debugging operations
		public const uint c_Debugging_Thread_Create = 0x00020010;
		// Creates a new thread, based on a static method.
		public const uint c_Debugging_Thread_List = 0x00020011;
		// Lists the active/waiting threads.
		public const uint c_Debugging_Thread_Stack = 0x00020012;
		// Lists the call stack for a thread.
		public const uint c_Debugging_Thread_Kill = 0x00020013;
		// Kills a thread.
		public const uint c_Debugging_Thread_Suspend = 0x00020014;
		// Suspends the execution of a thread.
		public const uint c_Debugging_Thread_Resume = 0x00020015;
		// Resumes the execution of a thread.
		public const uint c_Debugging_Thread_GetException = 0x00020016;
		// Gets the current exception.
		public const uint c_Debugging_Thread_Unwind = 0x00020017;
		// Unwinds to given stack frame.
		public const uint c_Debugging_Thread_CreateEx = 0x00020018;
		// Creates a new thread as Debugging_Thread_Create that borrows the identity of another thread.
		public const uint c_Debugging_Thread_Get = 0x00021000;
		// Gets the current thread.
		public const uint c_Debugging_Stack_Info = 0x00020020;
		// Gets more info on a stack frame.
		public const uint c_Debugging_Stack_SetIP = 0x00020021;
		// Sets the IP on a given stack frame.
		public const uint c_Debugging_Value_ResizeScratchPad = 0x00020030;
		// Resizes the scratchpad area.
		public const uint c_Debugging_Value_GetStack = 0x00020031;
		// Reads a value from the stack frame.
		public const uint c_Debugging_Value_GetField = 0x00020032;
		// Reads a value from an object's field.
		public const uint c_Debugging_Value_GetArray = 0x00020033;
		// Reads a value from an array's element.
		public const uint c_Debugging_Value_GetBlock = 0x00020034;
		// Reads a value from a heap block.
		public const uint c_Debugging_Value_GetScratchPad = 0x00020035;
		// Reads a value from the scratchpad area.
		public const uint c_Debugging_Value_SetBlock = 0x00020036;
		// Writes a value to a heap block.
		public const uint c_Debugging_Value_SetArray = 0x00020037;
		// Writes a value to an array's element.
		public const uint c_Debugging_Value_AllocateObject = 0x00020038;
		// Creates a new instance of an object.
		public const uint c_Debugging_Value_AllocateString = 0x00020039;
		// Creates a new instance of a string.
		public const uint c_Debugging_Value_AllocateArray = 0x0002003A;
		// Creates a new instance of an array.
		public const uint c_Debugging_Value_Assign = 0x0002003B;
		// Assigns a value to another value.
		public const uint c_Debugging_TypeSys_Assemblies = 0x00020040;
		// Lists all the assemblies in the system.
		public const uint c_Debugging_TypeSys_AppDomains = 0x00020044;
		// Lists all the AppDomans loaded.
		public const uint c_Debugging_Resolve_Assembly = 0x00020050;
		// Resolves an assembly.
		public const uint c_Debugging_Resolve_Type = 0x00020051;
		// Resolves a type to a string.
		public const uint c_Debugging_Resolve_Field = 0x00020052;
		// Resolves a field to a string.
		public const uint c_Debugging_Resolve_Method = 0x00020053;
		// Resolves a method to a string.
		public const uint c_Debugging_Resolve_VirtualMethod = 0x00020054;
		// Resolves a virtual method to the actual implementation.
		public const uint c_Debugging_Resolve_AppDomain = 0x00020055;
		// Resolves an AppDomain to it's name, and list its loaded assemblies.
		...
		//
		public const uint c_Debugging_Lcd_NewFrame = 0x00020070;
		// Reports a new frame sent to the LCD.
		public const uint c_Debugging_Lcd_NewFrameData = 0x00020071;
		// Reports a new frame sent to the LCD, with its contents.
		public const uint c_Debugging_Lcd_GetFrame = 0x00020072;
		// Requests the current frame.
		public const uint c_Debugging_Button_Report = 0x00020080;
		// Reports a button press/release.
		public const uint c_Debugging_Button_Inject = 0x00020081;
		// Injects a button press/release.
		public const uint c_Debugging_Messaging_Query = 0x00020090;
		// Checks the presence of an EndPoint.
		public const uint c_Debugging_Messaging_Send = 0x00020091;
		// Sends a message to an EndPoint.
		public const uint c_Debugging_Messaging_Reply = 0x00020092;
		// Response from an EndPoint.
		public const uint c_Debugging_Logging_GetNumberOfRecords = 0x000200A0;
		// Returns the number of records in the log.
		public const uint c_Debugging_Logging_GetRecord = 0x000200A1;
		// Returns the n-th record in the log.
		public const uint c_Debugging_Logging_Erase = 0x000200A2;
		// Erases the logs.
		public const uint c_Debugging_Logging_GetRecords = 0x000200A3;
		// Returns multiple records, starting from the n-th record.
		public const uint c_Debugging_Deployment_Status = 0x000200B0;
		// Returns entryPoint and boundary of deployment area.
		public const uint c_Debugging_Info_SetJMC = 0x000200C0;
		// Sets code to be flagged as JMC (Just my code).
		public const uint c_Profiling_Command = 0x00030000;
		// Controls various aspects of profiling.
		public const uint c_Profiling_Stream = 0x00030001;
		// Stream for MFProfiler information.
		...
		public class Debugging_Execution_ChangeConditions
		{
			...
			public const int c_fDebugger_Quiet = 0x00010000;
			// Do not spew debug text to the debugger
			public const uint c_PauseTimers = 0x04000000;
			// Threads associated with timers are created in "suspended" mode.
			public const uint c_NoCompaction = 0x08000000;
		...
		public class Debugging_Value_SetArray
		{
			...
			public uint m_index;
			public byte[] m_value = new byte[8];
			// Only primitive support for now
		}
		...
		public class Debugging_Resolve_Assembly
		{
			...
			public class Reply
			{
				...
				public byte[] m_nameBuffer = new byte[512];
				// char
				[NonSerialized]
